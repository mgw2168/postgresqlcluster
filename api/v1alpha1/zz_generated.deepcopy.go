...
func (in *PgBackup) DeepCopyInto(out *PgBackup) {
	*out = *in
	if in.BackupReference != nil {
		in, out := &in.BackupReference, &out.BackupReference
...
func (in *PostgreSQLClusterStatus) DeepCopyInto(out *PostgreSQLClusterStatus) {
	*out = *in
	...
	if in.BackupDeletingQueue != nil {
		in, out := &in.BackupDeletingQueue, &out.BackupDeletingQueue
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
